<?php
	...
	include_once "stu_view_files.php";
?>
<html>
<head>
...
<body>
	<?php
		...
		$query0="SELECT * FROM student_update WHERE Reg_no='$regno'";
		...
		{
			$bus1=$_POST["bus"];
			$query1="UPDATE student SET bus='$bus1',address='$address',fee_status='$fee_status',year='$year' 
					WHERE Reg_no='$regno'";
			...
			$query4="DELETE FROM student_update WHERE Reg_no='$regno'";
