...
?>
	<table cellpadding="20" width="60%" id="tbl">
		...
		<tr>
			...
			<td>:</td>
			<td><form method="POST" action="view_files.php"><button name="fee_receipt" type="submit" id="btn-Fee">Click here</button><input type="hidden" name="fee_receipt_view" value="<?php echo $row['Reg_no']; ?>" /></form></td>
		</tr>
	</table>
		<?php
			}
